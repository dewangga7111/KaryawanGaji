...
<table border="1">
    ...
    <?php 
      include 'tool/koneksi.php';
        ...
        $tahun = $_POST['tahun'];
         $no = 0;
        $query = mysqli_query($connect, "SELECT * FROM gaji INNER JOIN karyawan ON gaji.nik=karyawan.nik WHERE MONTH(gaji.tanggal)='$bulan' AND YEAR(gaji.tanggal)='$tahun'")or die(mysql_error);
        $no++;
