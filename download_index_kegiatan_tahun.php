...
<table border="1">
    ...
    <?php 
      include 'tool/koneksi.php';
        ...
        $tahun = $_POST['tahun'];
        $query = mysqli_query($connect, "SELECT * FROM kegiatan INNER JOIN karyawan ON kegiatan.nik=karyawan.nik WHERE   YEAR(kegiatan.tgl_mulai)='$tahun' ORDER BY kegiatan.tgl_mulai DESC")or die(mysql_error);
