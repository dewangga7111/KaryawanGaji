...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Izin</span>
</div>
...
<div class="row" style="margin-left:1px">
  ...
  <div class="collapse" id="collapseExample">
      ...
      <form class="form-row"action="fungsi_rekap_izin.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
    ...
    <form class="form-row" action="export_index_izin_orang.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Nama
    ...
    <form class="form-row" action="export_index_izin_bulan.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Bulan
        <div class="col-md-2.5 mb-3">
        <select name="bulan" class="form-control" style="width:200px">
        <option value="01">Januari</option>
    ...
    <form class="form-row" action="export_index_izin_tahun.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
