...
<div id="mySidenav" class="sidenav" style="  background: #caf2c4;">
  ...
  <a style="color:blck; font-size: 20px; opacity:0.9" href="index_profile.php">profile</a>
...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Tambah Biodata</span>
</div>
    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="tambah_profile.php?nik=<?php echo $result->nik?>" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="status_nikah" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="sosial_media" >
                                    </div>
                                </div>
                                <div class="form-group row">
