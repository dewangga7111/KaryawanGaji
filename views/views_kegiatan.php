...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Kegiatan</span>
</div>
...
<div class="row" style="margin-left:1px">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <div class="col-md-4 mb-3">
        <h5>Cari Bulan Mulai</h5>  
    </div>
      <form class="form-row"action="fungsi_rekap_kegiatan.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
    ...
    <form class="form-row" action="export_index_kegiatan_orang.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Nama
    ...
    <form class="form-row" action="export_index_kegiatan_bulan.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Bulan
        <div class="col-md-2.5 mb-3">
        <select name="bulan" class="form-control" style="width:200px">
        <option value="01">Januari</option>
    ...
    <form class="form-row" action="export_index_kegiatan_tahun.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Tahun
          <div class="col-md-2.5 mb-3">
        <select name="tahun" class="form-control" style="width:200px"> 
        <?php
...
<table class="table table-striped">
	...
	?>
        <tr>
            ...
            <td><a href="ubah_kegiatan.php?id_kegiatan=<?php echo $result->id_kegiatan?>"><button type="button" class="btn btn-warning">Ubah</button></a></td>
        </tr>
    <?php
       }
    ?>
