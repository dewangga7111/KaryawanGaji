        ...
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0">Kasbon</h4>
                        </div>
                        <div class="card-body">
                            <form action="bayar_kasbon.php?id_kasbon=<?php echo $result->id_kasbon?>" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">ID Kasbon</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="id_kasbon" value="<?php echo $result->id_kasbon?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Bayar</label>
                                    <div class="col-lg-9">
