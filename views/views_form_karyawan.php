...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Tambah Karyawan</span>
</div>
    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="tambah_karyawan.php" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="pass_efin" >
                                    </div>
                                </div>
                                       <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="nilai_test_english" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Tanggal Mulai Kerja</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tgl_mulai_kerja" id="tgl_mulai_kerja" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Tanggal Abis Kontrak</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tgl_abis_kontrak" id="tgl_abis_kontrak" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Tanggal Resign</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tgl_resign" id="tgl_resign" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="no_lain" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="pendidikan_akhir" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Tanggal Ijazah</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tgl_ijazah" id="tgl_ijazah" >
                                    </div>
                                </div>
                                <div class="form-group row">
