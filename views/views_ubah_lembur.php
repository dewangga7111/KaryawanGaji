...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Ubah Lembur</span>
</div>
        ...
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0">Data Lembur</h4>
                        </div>
                        <div class="card-body">
                            <form action="ubah_lembur.php?id_lembur=<?php echo $result->id_lembur?>" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off" name="form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tempat_lembur"  value="<?php echo $result->nama_tempat?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Nama Pekerjaan</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="pekerjaan"  value="<?php echo $result->nama_pekerjaan?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">tanggal</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="tanggal"  value="<?php echo $result->tanggal?>" >
                                    </div>
                                </div>
                                       <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Status Hari</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="status_hari"  value="<?php echo $result->status_hari?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Jam Mulai</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="jam_mulai"  value="<?php echo $result->jam_mulai?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Jam Selesai</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="jam_selesai"  value="<?php echo $result->jam_selesai?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Jumlah Jam</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="jumlah_jam"  value="<?php echo $result->jumlah_jam?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Honor</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="honor"  value="<?php echo $result->honor?>" >
                                    </div>
                                </div>
