...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Tambah Admin</span>
</div>
    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="tambah_admin.php" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">
