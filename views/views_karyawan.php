...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Karyawan</span>
</div>

<div class="container-fluid" style="margin-top:100px; width:1200px; background:#edeeef; border-radius:15px;">
    <div class="row">
<div class="btn-group" role="group" aria-label="Button group with nested dropdown" style="margin-bottom:30px; margin-top:30px"> 
    <a href="tambah_karyawan.php">
        <button type="button" class="btn btn-secondary" style="margin-left:15px; border-top-right-radius:0px; border-bottom-right-radius:0px;">Tambah Karyawan</button>
    </a>
  ...
  <div class="btn-group" role="group">
    ...
    <a href="export_index_karyawan.php"><button class="btn btn-success" style="margin-left:10px; margin-top:30px">Unduh</button></a>
