...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Piket Malam</span>
</div>
...
<div class="container-fluid" style="margin-top:100px; width:1200px; background:#edeeef; border-radius:15px;">
  ...
  <div class="collapse" id="collapseExample">
      ...
      <form class="form-row"action="fungsi_rekap_piket.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px; ">
    ...
    <form class="form-row" action="export_index_piket_orang.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Nama
    ...
    <form class="form-row" action="export_index_piket_bulan.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Bulan
        <div class="col-md-2.5 mb-3">
        <select name="bulan" class="form-control" style="width:200px">
        <option value="01">Januari</option>
    ...
    <form class="form-row" action="export_index_piket_tahun.php" class="form-horizontal" method="post" enctype="multipart/form-data" style="margin-left:10px">
        Tahun
          <div class="col-md-2.5 mb-3">
        <select name="tahun" class="form-control" style="width:200px"> 
        <?php
