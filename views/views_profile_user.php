...
function drawChart() {
    ...
    var data = google.visualization.arrayToDataTable([
      ['Status', 'Jumlah'],
      ['Kehadiran', <?php echo $result3->total_hadir?>],['alpa', <?php echo $result3->total_alpa?>],['izin', <?php echo $result3->total_izin?>],
      
    ]);
    var options = {
        title: 'Kehadiran',
       backgroundColor: { fill: "#edeff2" },
        width: 400,
        height: 300,
...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Profile</span>
</div>
<div class="container emp-profile">
    <div class="progress" style="margin-bottom:50px">
        <div class="progress-bar progress-bar-striped progress-bar-animated" style="width: <?php echo $result4->persen?>%"><?php echo $result4->persen?>% | <?php echo $result4->sekarang?> Jam dari 160</div>
    </div>
            <form method="post">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <ul class="pagination">
                          <li class="page-item"><a class="page-link" href="tambah_profile.php?nik=<?php echo $result->nik?>">Tambah Biodata</a></li>
                          <li class="page-item" style="width:600px"><a class="page-link" href="ubah_profile.php?nik=<?php echo $result->nik?>">Edit Biodata</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <hr width="80%" align="center" color="#d9dce0" style="opacity:0.7">
                        <div id="piechart"></div>
                    </div>
                    <div class="col-md-8">
