    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="tambah_kasbon.php" class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Total Kasbon</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="total_pinjam" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Jumlah Angsuran</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="jumlah_angsuran" >
                                    </div>
                                </div>
                                <div class="form-group row">
