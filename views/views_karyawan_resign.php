...
<div id="main" class="container-fluid shadow" style="background: #edeeef">
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Menu | Resign</span>
</div>
...
<div class="btn-group" role="group" aria-label="Button group with nested dropdown" style="margin-bottom:30px; margin-left:15px;margin-top:30px"> 
  ...
  <div class="btn-group" role="group">
    ...
    <a href="export_index_karyawan_resign.php"><button class="btn btn-success" style="margin-left:10px; margin-top:30px">Unduh</button></a>
        </div>
