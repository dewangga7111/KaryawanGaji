...
<table border="1">
    ...
    <?php 
      include 'tool/koneksi.php';
        $no = 0;
        $tahun = $_POST['tahun'];
        $query = mysqli_query($connect, "SELECT * FROM lembur INNER JOIN karyawan ON lembur.nik=karyawan.nik WHERE  YEAR(lembur.tanggal)='$tahun' ORDER BY lembur.tanggal")or die(mysql_error);
