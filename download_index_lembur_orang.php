...
<table border="1">
    ...
    $bulan = $_POST['bulan'];
        $tahun = $_POST['tahun'];
        $query = mysqli_query($connect, "SELECT * FROM lembur INNER JOIN karyawan ON lembur.nik=karyawan.nik WHERE karyawan.nik='$nik' AND MONTH(lembur.tanggal)='$bulan' AND YEAR(lembur.tanggal)='$tahun' ORDER BY lembur.tanggal")or die(mysql_error);
